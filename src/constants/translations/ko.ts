...
const ko: Record<string, string> = {
    ...
    auth_googleSignInFailed: 'Google 로그인에 일시적인 문제가 있습니다. 수정 중입니다',
    ...
    admin_typeNationwide: '전국 이벤트',
    admin_typeLimited: '한정 이벤트',
    ...
    // #057 탐색
    mini_exploreTitle: '탐색',
    mini_exploreIntro: 'MINI를 탐색에 보내세요!',
    mini_exploreCity: '도시',
    mini_exploreDistrict: '지역',
    mini_exploreCityPlaceholder: '도시 이름 입력',
    mini_exploreDistrictPlaceholder: '지역 이름 입력',
    mini_exploreStart: '탐색 시작',
    mini_exploreExploring: 'MINI가 탐색 중...',
    mini_exploreLocation: '탐색 장소',
    mini_exploreTimeLeft: '남은 시간',
    mini_exploreReady: '탐색 완료!',
    mini_exploreReadyDesc: 'MINI가 새로운 발견을 했어요! 지금 받으세요!',
    mini_exploreClaim: '결과 받기',
    mini_exploreClaimSuccess: '탐색 결과',
    mini_exploreClaimDesc: 'MINI가 다음 장소를 발견했습니다:',
    mini_exploreCompleted: '완료된 탐색',
    mini_exploreEmpty: '아직 탐색 기록이 없습니다',
    mini_exploreStartFail: '탐색 시작에 실패했습니다. 다시 시도해 주세요',
    mini_exploreClaimFail: '받기에 실패했습니다. 다시 시도해 주세요',

    // #060 부고양이 도감
    mini_subCatTitle: '부고양이 도감',
    mini_subCatCollection: '수집 완료',
    mini_subCatAll: '전체',
    mini_subCatExploration: '탐색',
    mini_subCatResource: '자원',
    mini_subCatFunction: '기능',
    mini_subCatBenefit: '혜택',
    mini_subCatOwned: '보유',
    mini_subCatUnowned: '미보유',
    mini_subCatHint: '획득 방법',
    mini_subCatBonus: '보너스 효과',
    mini_subCatBonusSummary: '보너스 요약',
    mini_subCatAcquired: '획득일',
    mini_subCatEmpty: '아직 수집한 부고양이가 없습니다',
    mini_subCatRarityCommon: '일반',
    mini_subCatRarityRare: '희귀',
    mini_subCatRarityEpic: '에픽',
    mini_subCatRarityLegendary: '전설',

    // #061 육성
    mini_nurtureTitle: '육성',
    mini_nurtureSatiety: '포만감',
    mini_nurtureBondLevel: '유대 레벨',
    mini_nurtureHeartProgress: '호감도 진행',
    mini_nurtureNextMilestone: '다음 마일스톤',
    mini_nurtureBondToGo: '유대 {count} 남음',
    mini_nurtureCatFood: '고양이 사료',
    mini_nurtureFeedCount: '오늘 {count}/{limit}회 급여',
    mini_nurtureFeed: '급여',
    mini_nurtureFeedSuccess: '급여 성공',
    mini_nurtureFeedResult: '포만감 {before}% → {after}%, 유대 +{bond}',
    mini_nurtureStageUp: '성장 레벨 업!',
    mini_nurtureStageUpDesc: 'MINI가 {stage}(으)로 성장했습니다!',
    mini_nurtureFeedNoFood: '고양이 사료가 없습니다',
    mini_nurtureFeedLimitReached: '오늘 급여 횟수 한도에 도달했습니다',
    mini_nurtureFeedFail: '급여에 실패했습니다. 다시 시도해 주세요',
    mini_nurtureLogsTitle: '육성 기록',
    mini_nurtureLogsEmpty: '아직 육성 기록이 없습니다',

    // #070 매장 바인딩
    merchant_bindStore: '매장 연결 (선택사항)',
    merchant_bindStoreDesc: '매장을 연결하여 여행자가 쉽게 찾을 수 있게',
    merchant_bindSearch: '기존 검색',
    merchant_bindUrl: '구글 지도',
    merchant_bindManual: '수동 입력',
    merchant_bindSearchPlaceholder: '매장명 검색 (2자 이상)',
    merchant_bindManualPlaceholder: '매장명 입력',
    merchant_bindResolve: '분석',
    merchant_bindResolving: '분석 중...',
    merchant_bindResolveFail: '분석에 실패했습니다. URL을 확인해 주세요',
    merchant_bindSelected: '선택한 매장',
    merchant_bindClear: '지우기',

    itemBox_packOpenSuccess: '열기 완료',
    // AI 데이터 공유 동의 (Apple Guideline 5.1.2(i) #062)
    aiDisclosure_title: 'AI 데이터 공유',
    aiDisclosure_message: '이 기능은 Google Gemini AI 서비스를 사용합니다. 계속하면 다음 데이터 처리에 동의하게 됩니다:',
    aiDisclosure_feature1: '대화 내용이 Google 서버로 전송되어 처리됩니다',
    aiDisclosure_feature2: '맞춤형 여행 추천 및 스마트 대화 생성에 사용',
    aiDisclosure_dataNote: 'Google은 귀하의 데이터를 AI 모델 훈련에 사용하지 않습니다',
    aiDisclosure_accept: '동의 후 계속',
    aiDisclosure_decline: '동의하지 않음',
    settings_aiDataSharing: 'AI 데이터 공유',
    ...
    // ============ #071 계정 연결 ============
    settings_linkedAccounts: '로그인 방법 관리',
    linkedAccounts_title: '로그인 방법 관리',
    linkedAccounts_currentProvider: '가입 방법',
    linkedAccounts_linked: '연결됨',
    linkedAccounts_link: '연결',
    linkedAccounts_unlink: '연결 해제',
    linkedAccounts_unlinkConfirm: '연결을 해제하시겠습니까?',
    linkedAccounts_unlinkConfirmDesc: '해제 후 다시 연결하려면 OAuth 인증이 필요합니다',
    linkedAccounts_linkSuccess: '연결되었습니다',
    linkedAccounts_unlinkSuccess: '연결이 해제되었습니다',
    linkedAccounts_errorAlreadyLinked: '이 계정은 다른 사용자에게 연결되어 있습니다',
    linkedAccounts_errorOnlyMethod: '유일한 로그인 방법은 해제할 수 없습니다',
    linkedAccounts_errorVerifyFailed: '로그인 인증에 실패했습니다. 다시 시도해 주세요',
    linkedAccounts_apple: 'Apple',
    linkedAccounts_google: 'Google',
    linkedAccounts_guest: '게스트',
