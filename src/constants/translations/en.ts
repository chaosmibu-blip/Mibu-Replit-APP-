...
const en: Record<string, string> = {
    ...
    admin_typeNationwide: 'Nationwide',
    admin_typeLimited: 'Limited',
    ...
    // #047 Rewards
    admin_rewardsTab: 'Rewards',
    admin_sendReward: 'Send Reward',
    admin_rewardTarget: 'Target',
    admin_rewardTargetAll: 'All Users',
    admin_rewardTargetUsers: 'Specific Users',
    admin_rewardTitle: 'Reward Title',
    admin_rewardMessage: 'Message (optional)',
    admin_rewardType: 'Reward Type',
    admin_rewardAmount: 'Amount',
    admin_rewardItemCode: 'Item Code',
    admin_rewardUserIds: 'User IDs (one per line)',
    admin_rewardAddItem: 'Add Reward Item',
    admin_rewardSending: 'Sending...',
    admin_rewardSuccess: 'Rewards Sent',
    admin_rewardSentStats: 'Sent to {sent}/{total} users in {batches} batch(es)',
    admin_rewardFillRequired: 'Please fill in the title and add at least one reward',
    admin_rewardNoUsers: 'Please enter at least one user ID',
    admin_rewardCoins: 'Coins',
    admin_rewardShopItem: 'Shop Item',
    admin_rewardPerk: 'Perk Boost',
    admin_rewardRemoveItem: 'Remove',
    admin_expiresInDays: 'Expires in days (optional)',

    // #048 Shop Items
    admin_shopItemsTab: 'Shop',
    admin_shopItemsManage: 'Shop Item Management',
    admin_shopItemCreate: 'Add Item',
    admin_shopItemEdit: 'Edit Item',
    admin_shopItemCode: 'Item Code',
    admin_shopItemName: 'Item Name',
    admin_shopItemNameEn: 'English Name (optional)',
    admin_shopItemDesc: 'Description',
    admin_shopItemDescEn: 'English Description (optional)',
    admin_shopItemPrice: 'Price (Coins)',
    admin_shopItemCategory: 'Category',
    admin_shopItemMaxPerUser: 'Max per User (optional)',
    admin_shopItemActive: 'Active',
    admin_shopItemInactive: 'Inactive',
    admin_shopItemConfirmDelete: 'Deactivate this item?',
    admin_shopItemNoItems: 'No items yet',
    admin_shopItemSortOrder: 'Sort Order',
    admin_shopCatGachaTicket: 'Gacha Ticket',
    admin_shopCatInventoryExpand: 'Inventory Expand',
    admin_shopCatCosmetic: 'Cosmetic',
    admin_shopCatBoost: 'Boost',
    admin_shopCatBundle: 'Bundle',
    admin_shopCatOther: 'Other',
    admin_shopItemFillRequired: 'Please fill in code, name and price',
    ...
    // ========== Partner Apply (#053) ==========
    partner_applyTitle: 'Apply to Become a Partner',
    partner_applyDesc: 'Become a Mibu local partner and help travelers plan authentic trips',
    partner_applyButton: 'Submit Application',
    partner_applySuccess: 'Application Submitted!',
    partner_applySuccessDesc: 'We will review your application as soon as possible',
    partner_statusPending: 'Under Review',
    partner_statusPendingDesc: 'Your partner application is being reviewed',
    partner_statusApproved: 'Approved',
    partner_statusRejected: 'Rejected',
    ...
    merchant_applyDesc: 'Join Mibu merchant partners and let more travelers discover your shop',
    merchant_applyButton: 'Submit Application',
    merchant_applySuccess: 'Application Submitted!',
    merchant_applySuccessDesc: 'We will review your merchant application shortly',
    merchant_statusNone: 'Not Applied',
    merchant_statusPending: 'Under Review',
    merchant_statusPendingDesc: 'Your merchant application is being reviewed',
    merchant_statusApproved: 'Approved',
    merchant_statusRejected: 'Rejected',
    merchant_statusRejectedDesc: 'Sorry, your merchant application was not approved',
    merchant_reapply: 'Reapply',
    merchant_businessName: 'Business Name',
    merchant_businessNamePlaceholder: 'Enter your business name',
    ...
    settings_merchantApply: 'Apply to Become a Merchant',
    settings_applicationPending: 'Under Review',
    settings_applicationRejected: 'Application rejected, you can reapply',
    ...
    auth_googleSignInFailed: 'Google Sign In has a temporary issue, we are working on it',
    ...
    auth_suggestMergeTitle: 'Existing Account Detected',
    auth_suggestMergeHasAccount: 'An account "{name}" was found on this device.',
    auth_suggestMergeHint: 'To merge accounts, go to Settings > Merge Account.',
    ...
    event_longTerm: 'Long-term Event',
    ...
    economy_partnerEligibility: 'Partner Eligibility',
    economy_canApplyNow: 'You can apply now!',
    economy_unlockRequirement: 'All logged-in users can apply',
    ...
    home_days: 'd',
    home_partnerReady: 'Partner Ready',
    ...
    itemBox_loading: 'Loading...',
    itemBox_loadFailed: 'Load Failed',
    itemBox_loadFailedDesc: 'Failed to load inventory items. Please try again later.',
    itemBox_full: 'Item box is full! Please delete or use some coupons before drawing.',
    itemBox_almostFull: 'Item box almost full, {remaining} slots remaining',
    itemBox_slotExpired: 'EXP',
    itemBox_slotUsed: 'USED',
    itemBox_expired: 'Expired',
    itemBox_validUntil: 'Valid until {date}',
    itemBox_close: 'Close',
    itemBox_redeem: 'Redeem',
    itemBox_redeemTitle: 'Redeem Coupon',
    itemBox_redeemInputLabel: 'Enter Merchant Redemption Code',
    itemBox_redeemPlaceholder: '8-digit code',
    itemBox_redeemConfirm: 'Confirm Redemption',
    itemBox_redeemSuccess: 'Redeemed!',
    itemBox_redeemShowMerchant: 'Please show this screen to the merchant',
    itemBox_redeemCountdown: 'Countdown',
    itemBox_redeemDone: 'Done',
    itemBox_redeemNotice: 'Notice',
    itemBox_redeemEnterCode: 'Please enter merchant redemption code',
    itemBox_redeemFailed: 'Redemption Failed',
    itemBox_redeemInvalidCode: 'Invalid Code',
    itemBox_redeemInvalidCodeDesc: 'Please check the redemption code from the merchant',
    itemBox_redeemExpired: 'This coupon has expired',
    itemBox_redeemAlreadyUsed: 'Already Used',
    itemBox_redeemAlreadyUsedDesc: 'This coupon has already been used',
    itemBox_redeemError: 'Redemption failed. Please try again.',
    itemBox_deleteTitle: 'Delete Item?',
    itemBox_deleteDesc: 'This action cannot be undone',
    itemBox_deleteCancel: 'Cancel',
    itemBox_deleteConfirm: 'Delete',
    itemBox_deleteFailed: 'Delete failed',
    itemBox_error: 'Error',
    ...
    // #057 Explore
    mini_exploreTitle: 'Explore',
    mini_exploreIntro: 'Send MINI to explore nearby attractions!',
    mini_exploreCity: 'City',
    mini_exploreDistrict: 'District',
    mini_exploreCityPlaceholder: 'Enter city name',
    mini_exploreDistrictPlaceholder: 'Enter district name',
    mini_exploreStart: 'Start Exploring',
    mini_exploreExploring: 'MINI is exploring...',
    mini_exploreLocation: 'Exploring',
    mini_exploreTimeLeft: 'Time Left',
    mini_exploreReady: 'Exploration Complete!',
    mini_exploreReadyDesc: 'MINI found new discoveries! Claim them now!',
    mini_exploreClaim: 'Claim Results',
    mini_exploreClaimSuccess: 'Exploration Results',
    mini_exploreClaimDesc: 'MINI discovered the following places:',
    mini_exploreCompleted: 'Completed Explorations',
    mini_exploreEmpty: 'No explorations yet',
    mini_exploreStartFail: 'Failed to start exploration, please try again',
    mini_exploreClaimFail: 'Failed to claim, please try again',

    // #060 Sub-Cat Catalog
    mini_subCatTitle: 'Sub-Cat Catalog',
    mini_subCatCollection: 'Collected',
    mini_subCatAll: 'All',
    mini_subCatExploration: 'Exploration',
    mini_subCatResource: 'Resource',
    mini_subCatFunction: 'Function',
    mini_subCatBenefit: 'Benefit',
    mini_subCatOwned: 'Owned',
    mini_subCatUnowned: 'Not Owned',
    mini_subCatHint: 'How to Acquire',
    mini_subCatBonus: 'Bonus Effect',
    mini_subCatBonusSummary: 'Bonus Summary',
    mini_subCatAcquired: 'Acquired Date',
    mini_subCatEmpty: 'No sub-cats collected yet',
    mini_subCatRarityCommon: 'Common',
    mini_subCatRarityRare: 'Rare',
    mini_subCatRarityEpic: 'Epic',
    mini_subCatRarityLegendary: 'Legendary',

    // #061 Nurture
    mini_nurtureTitle: 'Nurture',
    mini_nurtureSatiety: 'Satiety',
    mini_nurtureBondLevel: 'Bond Level',
    mini_nurtureHeartProgress: 'Heart Progress',
    mini_nurtureNextMilestone: 'Next Milestone',
    mini_nurtureBondToGo: '{count} bond to go',
    mini_nurtureCatFood: 'Cat Food',
    mini_nurtureFeedCount: 'Fed {count}/{limit} today',
    mini_nurtureFeed: 'Feed',
    mini_nurtureFeedSuccess: 'Feeding Success',
    mini_nurtureFeedResult: 'Satiety {before}% → {after}%, Bond +{bond}',
    mini_nurtureStageUp: 'Growth Level Up!',
    mini_nurtureStageUpDesc: 'MINI has grown to {stage}!',
    mini_nurtureFeedNoFood: 'No cat food left',
    mini_nurtureFeedLimitReached: 'Daily feed limit reached',
    mini_nurtureFeedFail: 'Feeding failed, please try again',
    mini_nurtureLogsTitle: 'Nurture Log',
    mini_nurtureLogsEmpty: 'No nurture logs yet',

    // #070 Store Binding
    merchant_bindStore: 'Bind Store (Optional)',
    merchant_bindStoreDesc: 'Bind your store to help travelers find you',
    merchant_bindSearch: 'Search Existing',
    merchant_bindUrl: 'Google Maps',
    merchant_bindManual: 'Manual Entry',
    merchant_bindSearchPlaceholder: 'Search store name (min 2 chars)',
    merchant_bindManualPlaceholder: 'Enter store name',
    merchant_bindResolve: 'Resolve',
    merchant_bindResolving: 'Resolving...',
    merchant_bindResolveFail: 'Resolution failed, please check the URL',
    merchant_bindSelected: 'Selected Store',
    merchant_bindClear: 'Clear',
    ...
    // ============ #071 Account Linking ============
    settings_linkedAccounts: 'Login Methods',
    linkedAccounts_title: 'Login Methods',
    linkedAccounts_currentProvider: 'Registered with',
    linkedAccounts_linked: 'Linked',
    linkedAccounts_link: 'Link',
    linkedAccounts_unlink: 'Unlink',
    linkedAccounts_unlinkConfirm: 'Unlink this method?',
    linkedAccounts_unlinkConfirmDesc: 'You will need to re-authenticate to link it again.',
    linkedAccounts_linkSuccess: 'Successfully linked',
    linkedAccounts_unlinkSuccess: 'Successfully unlinked',
    linkedAccounts_errorAlreadyLinked: 'This account is already linked to another user',
    linkedAccounts_errorOnlyMethod: 'Cannot unlink the only login method',
    linkedAccounts_errorVerifyFailed: 'Login verification failed, please try again',
    linkedAccounts_apple: 'Apple',
    linkedAccounts_google: 'Google',
    linkedAccounts_guest: 'Guest',
