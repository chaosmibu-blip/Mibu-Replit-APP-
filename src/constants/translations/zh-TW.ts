...
const zhTW: Record<string, string> = {
    ...
    auth_googleSignInFailed: 'Google 登入出了點問題，我們正在修復中',
    ...
    mini_exploreIntro: '派 MINI 去探索附近的景點！',
    mini_exploreCity: '城市',
    mini_exploreDistrict: '區域',
    mini_exploreCityPlaceholder: '輸入城市名稱',
    mini_exploreDistrictPlaceholder: '輸入區域名稱',
    mini_exploreStart: '開始探索',
    mini_exploreExploring: 'MINI 正在探索中...',
    mini_exploreLocation: '探索地點',
    mini_exploreTimeLeft: '剩餘時間',
    mini_exploreReady: '探索完成！',
    mini_exploreReadyDesc: 'MINI 帶回了新發現，快來領取吧！',
    mini_exploreClaim: '領取結果',
    mini_exploreClaimSuccess: '探索結果',
    mini_exploreClaimDesc: 'MINI 發現了以下景點：',
    mini_exploreCompleted: '已完成的探索',
    mini_exploreEmpty: '還沒有探索紀錄',
    mini_exploreStartFail: '啟動探索失敗，請稍後再試',
    mini_exploreClaimFail: '領取失敗，請稍後再試',

    // #060 副貓圖鑑
    mini_subCatTitle: '副貓圖鑑',
    mini_subCatCollection: '已收集',
    mini_subCatAll: '全部',
    mini_subCatExploration: '探索',
    mini_subCatResource: '資源',
    mini_subCatFunction: '功能',
    mini_subCatBenefit: '福利',
    mini_subCatOwned: '已擁有',
    mini_subCatUnowned: '未擁有',
    mini_subCatHint: '獲取方式',
    mini_subCatBonus: '加成效果',
    mini_subCatBonusSummary: '副貓加成總覽',
    mini_subCatAcquired: '獲得日期',
    mini_subCatEmpty: '還沒有收集到副貓',
    mini_subCatRarityCommon: '普通',
    mini_subCatRarityRare: '稀有',
    mini_subCatRarityEpic: '史詩',
    mini_subCatRarityLegendary: '傳說',

    // #061 養成
    mini_nurtureTitle: '養成',
    mini_nurtureSatiety: '飽食度',
    mini_nurtureBondLevel: '羈絆等級',
    mini_nurtureHeartProgress: '好感度進度',
    mini_nurtureNextMilestone: '下一個里程碑',
    mini_nurtureBondToGo: '還差 {count} 羈絆',
    mini_nurtureCatFood: '貓糧',
    mini_nurtureFeedCount: '今日已餵 {count}/{limit} 次',
    mini_nurtureFeed: '餵食',
    mini_nurtureFeedSuccess: '餵食成功',
    mini_nurtureFeedResult: '飽食度 {before}% → {after}%，羈絆 +{bond}',
    mini_nurtureStageUp: '成長升級！',
    mini_nurtureStageUpDesc: 'MINI 成長為{stage}了！',
    mini_nurtureFeedNoFood: '沒有貓糧了',
    mini_nurtureFeedLimitReached: '今日餵食次數已達上限',
    mini_nurtureFeedFail: '餵食失敗，請稍後再試',
    mini_nurtureLogsTitle: '養成紀錄',
    mini_nurtureLogsEmpty: '還沒有養成紀錄',

    // #070 商家綁定
    merchant_bindStore: '綁定店家（選填）',
    merchant_bindStoreDesc: '綁定您的店家，讓旅客更容易找到您',
    merchant_bindSearch: '搜尋現有',
    merchant_bindUrl: 'Google 地圖',
    merchant_bindManual: '手動輸入',
    merchant_bindSearchPlaceholder: '搜尋店家名稱（至少 2 字）',
    merchant_bindManualPlaceholder: '輸入店家名稱',
    merchant_bindResolve: '解析',
    merchant_bindResolving: '解析中...',
    merchant_bindResolveFail: '解析失敗，請確認連結是否正確',
    merchant_bindSelected: '已選擇店家',
    merchant_bindClear: '清除',
    ...
    // ============ #071 帳號連結 ============
    settings_linkedAccounts: '登入方式管理',
    linkedAccounts_title: '登入方式管理',
    linkedAccounts_currentProvider: '註冊方式',
    linkedAccounts_linked: '已綁定',
    linkedAccounts_link: '綁定',
    linkedAccounts_unlink: '解除綁定',
    linkedAccounts_unlinkConfirm: '確定要解除綁定嗎？',
    linkedAccounts_unlinkConfirmDesc: '解除後需重新進行 OAuth 驗證才能再次綁定',
    linkedAccounts_linkSuccess: '綁定成功',
    linkedAccounts_unlinkSuccess: '已解除綁定',
    linkedAccounts_errorAlreadyLinked: '此帳號已綁定到其他用戶',
    linkedAccounts_errorOnlyMethod: '無法解除唯一的登入方式',
    linkedAccounts_errorVerifyFailed: '登入驗證失敗，請重試',
    linkedAccounts_apple: 'Apple',
    linkedAccounts_google: 'Google',
    linkedAccounts_guest: '訪客',
